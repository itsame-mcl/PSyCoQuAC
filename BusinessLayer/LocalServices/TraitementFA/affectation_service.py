...
class AffectationService():
    ...
    def appliquer_repartition(session_utilisateur, repartition): # Répartition est un dictionnaire, avec comme clés les agents_id et comme valeurs les fiches_id 
