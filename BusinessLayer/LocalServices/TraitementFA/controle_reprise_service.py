...
from DataLayer.DAO.dao_pot import DAOPot

class ControleRepriseService() :
    def consulter_fiche(self, session_utilisateur, id_fiche, etat_final):
        pot = DAOPot.recuperer_pot(session_utilisateur.utilisateur_connecte) # récupère le pot de l'agent (à coder, à vérifier le nom de la classe)
    ...
    def modifier_fiche(self, session_utilisateur, id_fiche, nouvelles_informations):
        pot = DAOPot.recuperer_pot(session_utilisateur.utilisateur_connecte) # récupère le pot de l'agent
    ...
    def consulter_pot(self, session_utilisateur):
        pot = DAOPot.recuperer_pot(session_utilisateur.utilisateur_connecte)
        return pot