...
class TestAdresse(TestCase):
    def test_creer_adresse(self):
        ...
        self.assertEqual("Place Stanislas", voie)
    ...
    def test_egalite_adresses(self):
        ...
        # THEN
        self.assertTrue(adresse1 == adresse1)
        self.assertTrue(Adresse(90, "Place Stanislas", 44100, "NANTES") == adresse1)
